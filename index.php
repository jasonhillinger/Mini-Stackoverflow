        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class=\"well\">
                        <p><a href=\"profile.php\">". $_SESSION["username"] ."</a></p>
                    <a href=\"profile.php\"><img class=\"img-circle\" src=\"data:image/jpeg;base64, " . fetchProfilePic($_SESSION["username"]) . "\" alt=\"Profile Picture\" height=\"65\" width=\"65\"></a>
